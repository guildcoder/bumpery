...
const files=['index.html','lobby.css','lobby.js','tables.js','starbound.svg','game.html','game.css','config.js','leaderboard.js','physics.js','renderer.js','showtime.js','game.js','pwa.js','icon.svg','app.webmanifest','sw.js'];
