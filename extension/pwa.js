(function(root){
  ...
  if(!welcome){
    ...
    welcome.innerHTML='<img src="icons/icon-192.png" width="72" height="72" alt="Bumpery app icon"><p id="welcome-main" class="welcome-main">Make yourself at home.</p><p id="welcome-copy">Pick your table. More tables are coming.</p><p id="install-steps" hidden>In Safari, tap <b>Share</b> ↥, then <b>Add to Home Screen</b> and <b>Add</b>. If shown, keep <b>Open as Web App</b> on.</p><p id="install-detail" hidden>Your own app icon. Full-screen play. Offline pinball after the first online visit.</p><button id="welcome-close" type="button">Let’s play ↗</button>';
