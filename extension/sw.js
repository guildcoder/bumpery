...
const ASSETS=['./','./index.html','./lobby.css','./lobby.js','./tables.js','./starbound.svg','./game.html','./game.css','./layout.css','./config.js','./leaderboard.js','./physics.js','./renderer.js','./showtime.js','./game.js','./pwa.js','./icon.svg','./app.webmanifest','./icons/apple-touch-icon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
